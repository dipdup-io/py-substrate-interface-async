...
class ContractMetadata:
    ...
    async def init(self):
        await self.__parse_metadata()

    @classmethod
    async def create_from_file(cls, metadata_file: str, substrate: SubstrateInterface) -> "ContractMetadata":
        """
    ...
    async def __parse_metadata(self):
...
class ContractCode:
    ...
    @classmethod
    async def create_from_contract_files(cls, wasm_file: str, metadata_file: str,
        ...
        metadata = await ContractMetadata.create_from_file(metadata_file, substrate=substrate)

        return cls(code_hash=code_hash, metadata=metadata, wasm_bytes=wasm_bytes, substrate=substrate)

    @classmethod
    async def create_from_code_hash(cls, code_hash: bytes, metadata_file: str,
                              substrate: SubstrateInterface) -> "ContractCode":
        """
...
class ContractInstance:
    ...
    @classmethod
    async def create_from_address(cls, contract_address: str, metadata_file: str,
        ...
        metadata = await ContractMetadata.create_from_file(metadata_file, substrate=substrate)  # type: ignore[arg-type]

        res = cls(contract_address=contract_address, metadata=metadata, substrate=substrate)
        await res.init()
        return res
