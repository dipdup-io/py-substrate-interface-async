...
class KeyPairTestCase(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_create_mnemonic_multi_lang(self):
    ...
    async def test_create_sr25519_keypair(self):
        mnemonic = "old leopard transfer rib spatial phone calm indicate online fire caution review"
    ...
    async def test_only_provide_ss58_address(self):
    ...
    async def test_only_provide_public_key(self):
    ...
    async def test_provide_no_ss58_address_and_public_key(self):
        self.assertRaises(ValueError, Keypair)

    async def test_incorrect_private_key_length_sr25519(self):
        self.assertRaises(
            ValueError, Keypair, private_key='0x23', ss58_address='16ADqpMa4yzfmWs3nuTSMhfZ2ckeGtvqhPWCNqECEGDcGgU2'
        )

    async def test_incorrect_public_key(self):
    ...
    async def test_sign_and_verify_wrapping(self):
        mnemonic = Keypair.generate_mnemonic()
        keypair = Keypair.create_from_mnemonic(mnemonic)
    ...
    async def test_sign_missing_private_key(self):
    ...
    async def test_sign_unsupported_crypto_type(self):
    ...
    async def test_verify_unsupported_crypto_type(self):
        keypair = Keypair.create_from_private_key(
            ss58_address='16ADqpMa4yzfmWs3nuTSMhfZ2ckeGtvqhPWCNqECEGDcGgU2',
            private_key='0x1f1995bdf3a17b60626a26cfe6f564b337d46056b7a1281b64c649d592ccda0a9cffd34d9fb01cae1fba61aeed184c817442a2186d5172416729a4b54dd4b84e',
            crypto_type=3
    ...
    async def test_sign_and_verify_incorrect_signature(self):
        mnemonic = Keypair.generate_mnemonic()
        keypair = Keypair.create_from_mnemonic(mnemonic)
    ...
    async def test_sign_and_verify_invalid_signature(self):
        mnemonic = Keypair.generate_mnemonic()
        keypair = Keypair.create_from_mnemonic(mnemonic)
        signature = "Test"
        self.assertRaises(TypeError, keypair.verify, "Test123", signature)

    async def test_sign_and_verify_invalid_message(self):
        mnemonic = Keypair.generate_mnemonic()
        keypair = Keypair.create_from_mnemonic(mnemonic)
        signature = keypair.sign("Test123")
        self.assertFalse(keypair.verify("OtherMessage", signature))

    async def test_create_ed25519_keypair(self):
        mnemonic = "old leopard transfer rib spatial phone calm indicate online fire caution review"
    ...
    async def test_sign_and_verify_ed25519(self):
        mnemonic = Keypair.generate_mnemonic()
    ...
    async def test_sign_and_verify_invalid_signature_ed25519(self):
        mnemonic = Keypair.generate_mnemonic()
        keypair = Keypair.create_from_mnemonic(mnemonic, crypto_type=KeypairType.ED25519)
        signature = "0x4c291bfb0bb9c1274e86d4b666d13b2ac99a0bacc04a4846fb8ea50bda114677f83c1f164af58fc184451e5140cc8160c4de626163b11451d3bbb208a1889f8a"
        self.assertFalse(keypair.verify("Test123", signature))

    async def test_create_ecdsa_keypair_private_key(self):
    ...
    async def test_create_ecdsa_keypair_mnemonic(self):
    ...
    async def test_create_ecdsa_keypair_uri(self):
        mnemonic = "old leopard transfer rib spatial phone calm indicate online fire caution review"
    ...
    async def test_sign_and_verify_ecdsa(self):
        mnemonic = Keypair.generate_mnemonic()
        keypair = Keypair.create_from_mnemonic(mnemonic, crypto_type=KeypairType.ECDSA)
        signature = keypair.sign("Test123")
    ...
    async def test_sign_and_verify_invalid_signature_ecdsa(self):
        mnemonic = Keypair.generate_mnemonic()
        keypair = Keypair.create_from_mnemonic(mnemonic, crypto_type=KeypairType.ECDSA)
    ...
    async def test_unsupport_crypto_type(self):
        self.assertRaises(
    ...
    async def test_sign_and_verify_bytes(self):
        mnemonic = Keypair.generate_mnemonic()
        keypair = Keypair.create_from_mnemonic(mnemonic)
    ...
    async def test_sign_and_verify_public_ss58_address(self):
    ...
    async def test_sign_and_verify_public_ethereum_address(self):
    ...
    async def test_create_keypair_from_private_key(self):
        keypair = Keypair.create_from_private_key(
            ss58_address='16ADqpMa4yzfmWs3nuTSMhfZ2ckeGtvqhPWCNqECEGDcGgU2',
            private_key='0x1f1995bdf3a17b60626a26cfe6f564b337d46056b7a1281b64c649d592ccda0a9cffd34d9fb01cae1fba61aeed184c817442a2186d5172416729a4b54dd4b84e'
        )
    ...
    async def test_hdkd_hard_path(self):
        mnemonic = 'old leopard transfer rib spatial phone calm indicate online fire caution review'
    ...
    async def test_hdkd_soft_path(self):
        mnemonic = 'old leopard transfer rib spatial phone calm indicate online fire caution review'
    ...
    async def test_hdkd_default_to_dev_mnemonic(self):
    ...
    async def test_hdkd_create_uri_correct_ss58format(self):
    ...
    async def test_hdkd_nested_hard_soft_path(self):
    ...
    async def test_hdkd_nested_soft_hard_path(self):
    ...
    async def test_hdkd_nested_numeric_hard_path(self):
    ...
    async def test_hdkd_nested_numeric2_hard_path(self):
    ...
    async def test_hdkd_path_gt_32_bytes(self):
    ...
    async def test_hdkd_path_eq_32_bytes(self):
    ...
    async def test_hdkd_unsupported_password(self):
        self.assertRaises(NotImplementedError, Keypair.create_from_uri, DEV_PHRASE + '///test')

    async def test_reconstruct_path_fail(self):
    ...
    async def test_hdkd_multi_lang(self):
        mnemonic_path = "秘 心 姜 封 迈 走 描 朗 出 莫 人 口//0"
        keypair = Keypair.create_from_uri(mnemonic_path, language_code=MnemonicLanguageCode.CHINESE_SIMPLIFIED)
        self.assertNotEqual(keypair, None)
    ...
    async def test_create_from_encrypted_json(self):
    ...
    async def test_create_from_encrypted_json_ed25519(self):
    ...
    async def test_export_keypair_to_json(self):
